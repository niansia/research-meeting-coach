...
| [F02] | Compression setup accuracy was 65.1. | raw-notes.md:8 |
| [F03] | The 32-frame run returned to around 70. | raw-notes.md:9 |
| [F04] | The early-frame control is only half complete. | raw-notes.md:12 |
| [F05] | The paper note is external and unverified. | raw-notes.md:10 |
| [F06] | CUDA was unavailable for one day. | raw-notes.md:11 |
| [F07] | The attention visualization has not been started. | raw-notes.md:13 |
